/**
	...
	INFO:
		• Variables ENTER y TAB para html
		• Comprueba variables o muestra de que tipo es
		• Muestra mensajes de error.
		• Imprime un array en formato alert(), console.log() y html, y título.
		• Crea aleatorios de todo tipo (boleanos, palabras, caracteres, numeros, arrays)
		
		• Cookies: puede crear, borrar y editar las cookies
		• reglas de 3
		• alinear imagenes
		• habilida imagen de carga
