...
/* ✪ regla3( otroNum, maxOtroNum, num )
		...
		📖 Ejemplo:	regla3(500, 200, 50);

		NOTA:
			• Si el máximo de 500 es 200.
				el máximo de 50 es 20.
	si 500 es 200 cuanto será 50
	INFO: Formula de la regla de 3.
*/
regla3 = function(otroNum, maxOtroNum, num){
	// Comprobar: num
...
regla3_100 = function(numero, numMax){
	...
	else { return Math.round((numero * 100 / numMax).toFixed(2));}
};
